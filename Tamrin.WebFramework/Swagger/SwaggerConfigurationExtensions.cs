...
namespace Tamrin.WebFramework.Swagger
{
    public static class SwaggerConfigurationExtensions
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
                var xmlDocPath = Path.Combine(AppContext.BaseDirectory, "Tamrin_Api.xml");
                ...
                options.SwaggerDoc("v1", new OpenApiInfo { Version = "v1", Title = "Tamrin Api" });
                options.SwaggerDoc("v2", new OpenApiInfo { Version = "v2", Title = "Tamrin Api" });
